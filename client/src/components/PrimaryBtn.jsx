...
const PrimaryBtn = ({ label }) => {
  return (
    <div>
      <a
        href="#"
        className="group relative inline-flex items-center justify-start overflow-hidden bg-[#3C39C6] px-10 py-5  font-bold text-white transition-all duration-300 ease-in-out md:px-20"
      >
